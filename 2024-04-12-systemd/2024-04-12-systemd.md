...
summary: systemd 는 Linux 운영체제의 부팅 및 서비스 관리에 사용하는 시스템 관리 도구 입니다. systemd 를 사용하여 서비스를 실행, 종료 및 관리하는 방법에 대해 살펴봅니다.
tags:
  - linux
  - systemd
---
...
이제 서비스가 좀 더 세밀하게 동작하도록 구성 옵션에 대해 자세히 알아보겠습니다.
